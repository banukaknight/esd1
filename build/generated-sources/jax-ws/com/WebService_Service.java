 ...
 * 
 */
@WebServiceClient(name = "webService", targetNamespace = "http://wspackage/", wsdlLocation = "http://localhost:8080/WebServiceProject/webService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("http://wspackage/", "webService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceProject/webService?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://wspackage/", "webServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wspackage/", "webServicePort"), WebService.class, features);
    }
